...
#### Step 3. 使用`group_by()`建立村里指標 {#moi_vil_groupby}
...
## IV. 將村里指標匯總為鄉鎮市區指標 {#moi_town_groupby}
...
## V.. 視覺化測試（老年人口數 x 曾婚人口數） {#moi_visual_popul}
