...
::: chatgpt
**ChatGPT Prompt:** In R, how do I use \`cat()\` to ouput an HTML format string \`hstring\` to an HTML file and preview the HTML? Please show me a simple example

``` html
hstring <- "<html><head><title>Hello World</title></head><body><h1>Hello World!</h1></body></html>"
htmlfile <- file("output.html", "w")
cat(hstring, file = htmlfile)
close(htmlfile)
