...
使用案例：[Teach About Inequality With These 28 New York Times Graphs - The New York Times (nytimes.com)](https://www.nytimes.com/2021/05/11/learning/lesson-plans/teach-about-inequality-with-these-28-new-york-times-graphs.html)

資料維度：

1.  年齡組（Less than 35, 35-44, 45-54, 55-64, 65-74, 75 or order）
2.  年（1989, 1992, 1995, 1998, 2001, 2004, 2007, 2010, 2013, 2016, 2019）
3.  淨資產中位數（千美元）

預期結果：

![](images/paste-BD63D4DC.png)
...
NW %>%
    ggplot() + 
    aes(x=year, y=Net_Worth, color=Category) + 
    geom_line() + 
    geom_point(stat="identity")

NW %>%
    ggplot() + 
    aes(x=year, y=Net_Worth, fill=Category, color=Category) + 
    geom_line() + 
    geom_point() + 
