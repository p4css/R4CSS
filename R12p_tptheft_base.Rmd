...
# Using read.csv to read data at "data/臺北市住宅竊盜點位資訊-UTF8-BOM-1.csv"
# df <- 
# head(df) 
```
...
# Using function substr(vector, start, end)
# df$time <- # CODE HERE
...
```{r}
## table()
# counting the frequency of region variable df$time
# CODE HERE

# counting the frequency of time variable df$region
# CODE HERE
...
# Tabulating time and region variables df$time, df$region
# assign to a new variable res_table
# YOUR CODE HERE
...
# count() the frequency of time x region of dataframe df
# assign to a variable res_count
# CODE HERE
